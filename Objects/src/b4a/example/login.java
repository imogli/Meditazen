...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"login\")";
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Private Sub Button1_Click";
 //BA.debugLineNum = 34;BA.debugLine="StartActivity(perfil)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._perfil.getObject()));
 //BA.debugLineNum = 35;BA.debugLine="End Sub";
return "";
}
public static String  _devuelta_main_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub devuelta_main_Click";
